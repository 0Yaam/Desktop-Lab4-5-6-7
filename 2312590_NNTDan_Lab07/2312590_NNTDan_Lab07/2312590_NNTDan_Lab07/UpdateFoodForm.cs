...
namespace _2312590_NNTDan_Lab07
{
    public partial class UpdateFoodForm : Form
    {
        ...
        private bool ValidateUserInput()
        {
            ...
            {
                MessageBox.Show("Bạn chưa chọn loại món ăn, đồ uống", "Thông báo");
                return false;
            }
            ...
            if (nudFoodPrice.Value <= 0)
            {
                MessageBox.Show("Giá món ăn, đồ uống phải lớn hơn 0", "Thông báo");
                return false;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Food newFood = GetUpdateFood();

                Food oldFood = GetFoodById(_foodId);
