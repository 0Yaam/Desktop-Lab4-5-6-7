...
namespace _2312590_NNTDan_Lab07
{
    public partial class MenuForm : Form
    {
        ...
        private readonly Color _accent = Color.FromArgb(242, 168, 74); 
        ...
        private readonly Color _priceColor = Color.FromArgb(220, 53, 69);  
        ...
        private Control CreateCard(MenuItemRow it)
        {
            ...
            int innerPad = 14;
            int avatarSize = 64;
            int w = card.Width - innerPad * 2 - avatarSize - 12; 
        ...
        private int CalcCardWidth()
        {
            ...
            const int hMargin = 16;  

            var columns = Math.Max(1, containerW / (desired + hMargin));

            if (columns > 1)
            {
                var available = containerW - (columns + 1) * 8; 
